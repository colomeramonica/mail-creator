...
import { Button, CardFooter, Image } from '@chakra-ui/react'
...
export default function Birthdays({ file, desiredMonth }) {
  Birthdays.propTypes = {
    ...
    desiredMonth: PropTypes.number.isRequired
  };
          ...
          <>
            <div key={date} id={`birthday-card-${date}`}>
              ...
              <div className="flex flex-col p-1">
                ...
                <CardFooter className="flex flex-col items-start content-end ml-6 p-3">
                  <Image
                    alt="Jacto"
