...
const birthdayPhoto = require('../assets/birthday-photo.jpg');
...
interface BirthdayRow {
  // For example, assuming the 7th element (index 6) is a date represented as a number
...
export default function Birthdays({ file, desiredMonth }: BirthdayProps) {
  ...
  useEffect(() => {
    ...
    reader.onload = (e) => {
      ...
      if (result) {
        ...
        readXlsxFile(data).then((rows: unknown[]) => {
